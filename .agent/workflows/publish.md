...
Format: `MAJOR.MINOR.PATCH`
- Normal güncelleme → sadece PATCH artar: `5.2.7` → `5.2.8`
- PATCH 9'a ulaşınca → MINOR artar, PATCH sıfırlanır: `5.3.0` → `5.3.0`
- MINOR ve PATCH **hiçbir zaman çift haneye (10+) çıkmaz**
- Büyük mimari değişiklik → MAJOR artar: `5.9.9` → `6.0.0`
...
| Telegram'da Yanıt gönderildi boş (link yok) hatası | ✅ Düzeltildi — Python scriptlerinde tweet_url döndürüldü | v5.5.9 |
| x_daemon_current.py intent/tweet API Timeout hatası | ✅ Düzeltildi — social_intel.py'deki stabil modal mantığına geri dönüldü | v5.5.9 |
