...
async def run():
    try:
        ...
        await box.click()
        await page.keyboard.insert_text('Manual test for error toast: ' + str(asyncio.get_event_loop().time()))
        ...
        for i in range(count):
            toasts.append(await toast.nth(i).inner_text())
        print('TOASTS_JSON:', json.dumps(toasts))
