...
def acquire_lock(timeout_seconds=180, stale_seconds=600):
    """
    ...
    while True:
        ...
        try:
            ...
            try:
                        ...
                        with open(LOCK_FILE, 'r') as f:
                            ...
                            if created_str:
                                ...
                                if age > stale_seconds:
                                    print(f"Found STALE lock (Age: {age:.0f}s > {stale_seconds}s). Forcefully clearing...", file=sys.stderr)
                ...
                raise # Re-raise immediately to fail closed
